<%-- 
    Document   : AhsanManzil
    Created on : Jun 25, 2019, 8:30:12 PM
...
<body>
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax_window_in" data-parallax="scroll" data-image-src="img/dhaka/AhsanManzil1400.jpg" data-natural-width="1400" data-natural-height="420">
            ...
            <div id="sub_content_in_left">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1>Ahsan Manzil</h1>
                            <span><i class="icon_pin"></i> Ahsan Manzil - Dhaka</span>
                        </div>
                        <div class="col-md-4">
