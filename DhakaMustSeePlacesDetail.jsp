<%-- 
    Document   : DhakaMustSeePlacesDetail
    Created on : Jun 25, 2019, 8:08:57 PM
        ...
        <div id="sub_content_in">
            <div id="sub_content_in_left">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1>Duomo Cathedral</h1>
                            <span><i class="icon_pin"></i> Piazza del Duomo - Florence</span>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box_info">
                                <h3>Opening</h3>
                                <ul>
                                    <li><strong>Monday to Friday</strong>: 9.00am/5.00pm</li>
                                    <li><strong>Saturday - Sunday</strong>: 9.00am/5.00pm</li>
                                    <li><strong>Closed</strong>: 25/31 December</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="box_info">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Ticket price:</strong> Adults 12$/Childs 8$
                                    </li>
                                </ul>
