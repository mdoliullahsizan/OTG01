<%-- 
    Document   : LalbaghKella
    Created on : Jun 25, 2019, 10:00:25 PM
...
<body>
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax_window_in" data-parallax="scroll" data-image-src="img/dhaka/LalbaghKella1400.jpg" data-natural-width="1400" data-natural-height="420">
            ...
            <div id="sub_content_in_left">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h1>Lalbagh Fort</h1>
                            <span><i class="icon_pin"></i> Lalbagh Fort - Dhaka</span>
                        </div>
                        <div class="col-md-4">
