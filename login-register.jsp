<%-- 
    ...
    Created on : Apr 9, 2019, 12:25:10 PM
    ...
    <div class="container margin_30">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="box_login">
                    <strong><i class="icon_lock-open_alt"></i><h3>Create an account</h3></strong>
                    <form action="RegisterServlet" method="POST">
                        <div class="form-group">
                            <input name="fname" id="n1" type="text" class=" form-control required" placeholder="First Name">
                            <span class="input-icon"><i class="icon_pencil-edit"></i></span>
                        </div>
                        <div class="form-group">
                            <input name="lname" id="n2" type="text" class=" form-control required" placeholder="Last Name">
                            <span class="input-icon"><i class="icon_pencil-edit"></i></span>
                        </div>
                        <div class="form-group">
                            <input name="email" id="n3" type="text" class=" form-control required" placeholder="Email">
                            <span class="input-icon"><i class="icon_mail_alt"></i></span>
                        </div>
                        <div class="form-group">
                            <input name="pword" id="n4" type="text" class=" form-control required" placeholder="Password" <!-- id="password1" --> >
                            <span class="input-icon"><i class="icon_lock_alt"></i></span>
                        </div>
<!--                        <div class="form-group">
                            <input type="text" class=" form-control required" id="password2" placeholder="Confirm password">
                            <span class="input-icon"><i class="icon_lock_alt"></i></span>
                        </div>-->
                        <div id="pass-info" class="clearfix"></div>
                        <button class="button_login">Create an account</button>
                    </form>
                </div>
            </div>
        </div>
